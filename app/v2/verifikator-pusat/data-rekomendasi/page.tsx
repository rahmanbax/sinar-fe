...
const DataRekomendasiPusatPage = () => {
    ...
    const columns: ColumnDef<any>[] = [
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex justify-center">
                    <button
                        onClick={() => router.push(`/v2/verifikator-pusat/data-rekomendasi/detail?id=${row.id}`)}
        ...
        <DashboardLayout>
            <div className="flex flex-col gap-8">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/v2/verifikator-pusat/data-rekomendasi/ajukan-rekomendasi">
                        <ButtonComponent
...
export default DataRekomendasiPusatPage;
