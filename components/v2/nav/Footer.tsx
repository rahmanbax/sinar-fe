...
const Footer = () => {
  ...
  return (
    <footer className='py-6 px-6 md:px-10 border-t border-gray-200'>
      <div className='flex flex-col md:flex-row justify-between gap-10 md:gap-0'>
        ...
        <div className='space-y-5'>
          ...
          <div className='flex gap-1'>
            {/* <MapPin size={20} /> */}
            <p className='text-sm w-72 text-gray-500'>Jalan Raya Jakarta-Bogor KM 46, Cibinong, Kabupaten Bogor, Jawa Barat 16911</p>
          </div>
        </div>

        <div className='flex flex-col md:flex-row gap-8 md:gap-20'>
          <div className='space-y-4'>
            <h2 className='font-semibold text-gray-500'>Publik</h2>
          ...
          <div className='space-y-4'>
            <h2 className='font-semibold text-gray-500'>Akun</h2>
            <ul className='text-sm space-y-2 text-gray-700'>
          ...
          <div className='space-y-4'>
            <h2 className='font-semibold text-gray-500'>Kontak</h2>
            <ul className='text-sm space-y-2 text-gray-700'>
