        ...
        <DashboardLayout showNav={false}>
            <div className="w-full flex flex-col gap-8 py-4 md:px-12 lg:px-20">
                ...
                <nav className="flex items-center gap-2 text-sm text-gray-400">
                    <Link href="/v2/verifikator-provinsi" className="hover:text-navy-600 transition-colors">Dashboard</Link>
                    <ChevronRight size={14} />
                    <Link href="/v2/verifikator-provinsi/data-rekomendasi" className="hover:text-navy-600 transition-colors">Data Rekomendasi</Link>
                    <ChevronRight size={14} />
