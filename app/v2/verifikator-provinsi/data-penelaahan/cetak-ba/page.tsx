        ...
        <DashboardLayout>
            <Suspense fallback={
                ...
                <CetakBeritaAcaraForm 
                    backPath="/v2/verifikator-provinsi/data-penelaahan?tab=semua"
                    redirectAfterSubmit="/v2/verifikator-provinsi/data-penelaahan?tab=semua"
                />
            </Suspense>
        </DashboardLayout>
    )
...
export default CetakBaProvinsiPage
