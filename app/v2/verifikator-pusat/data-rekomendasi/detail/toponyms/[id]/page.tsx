...
const RecommendationToponymDetailPusatContent = () => {
...
const RecommendationToponymDetailPusatPage = () => {
    return (
        <DashboardLayout showNav={false} tightMargin={true}>
            ...
            >
                <RecommendationToponymDetailPusatContent />
            </Suspense>
        </DashboardLayout>
    );
};

export default RecommendationToponymDetailPusatPage;
