        ...
        <div className="h-full py-12 overflow-y-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="text-gray-500 max-w-xl mx-auto">Temukan jawaban atas pertanyaan umum (FAQ), dokumentasi, serta panduan pendaftaran dan penelaahan nama rupabumi secara lengkap.</p>
                </div>
            </div>
        </div>
    </PublicLayout>
