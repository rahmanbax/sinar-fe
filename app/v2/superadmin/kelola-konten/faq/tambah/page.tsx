...
import { useCreateFaqMutation } from "@/hooks/useCms";
...
const TambahFaqPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        createMutation.mutate(
            { token, data: { question, answer, order } },
            {
            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Tambah pertanyaan yang sering diajukan</p>
                    </div>
                </div>
