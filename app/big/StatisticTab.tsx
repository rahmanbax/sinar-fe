        ...
        <div className="block px-4">
            <div className="flex flex-col w-full gap-4">
                ...
                <div className="flex flex-col lg:flex-row w-full gap-6 items-center mb-5">
                    {/* Cards Grid */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-h-40">
                    ...
                    {/* Chart */}
                    <div className="w-full h-auto lg:max-w-3/4 md:h-[300px]">
                        <DemoChart />
                    </div>
                </div>

                <h3 className="text-lg text-center font-bold">Sebaran Nama Rupabumi di Indonesia</h3>
