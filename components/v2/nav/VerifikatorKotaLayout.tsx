...
interface VerifikatorKotaLayoutProps {
    children: React.ReactNode;
    showNav?: boolean;
    tightMargin?: boolean;
}

const VerifikatorKotaLayout = ({ children, showNav = true, tightMargin = false }: VerifikatorKotaLayoutProps) => {
    ...
    return (
        <div className="flex h-screen bg-slate-50/50 overflow-hidden">
            {/* Sidebar Navigation */}
            {showNav && <VerifikatorKotaNav isOpen={isMobileMenuOpen} onClose={() => setIsMobileMenuOpen(false)} />}
...
export default VerifikatorKotaLayout;