            ...
            cell: (row) => (
                <div className="flex justify-center">
                    <button
                        onClick={() =>
                            router.push(
                                `/v2/verifikator-provinsi/data-rekomendasi/detail/toponyms/${row.id}?transactionId=${transactionId}&rekomendasiId=${rekomendasiId}`
                            )
                        }
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center gap-3">
                <button
                    onClick={() => router.push(`/v2/verifikator-provinsi/data-rekomendasi/detail?id=${rekomendasiId}`)}
