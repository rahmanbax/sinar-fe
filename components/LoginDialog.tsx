        ...
        <form>
            <DialogContent className="bg-[#DBECFD] sm:max-w-[355px] px-2 pt-4" showCloseButton={false}>
                ...
                <div className="px-4 flex flex-col gap-3 justify-center">
                    ...
                    <Button className="bg-[#1378B7] hover:bg-blue-400">Masuk</Button>
                    ...
                    <Button className="bg-accent text-accent-foregroun hover:bg-slate-300"> <FaGoogle/> Masuk Dengan Google</Button>
                </div>
