        ...
        <DashboardLayout showNav={false}>
            <div className="w-full flex flex-col gap-8 py-4 md:px-12 lg:px-20">
                ...
                <nav className="flex items-center text-sm text-gray-500 gap-2" >
                    ...
                    <Link href="/v2/verifikator-provinsi/data-rekomendasi" className="hover:text-black transition-colors">Data Rekomendasi</Link>
                    <ChevronRight size={14} />
                    <span className="text-black">Ajukan Rekomendasi</span>
                </nav>
