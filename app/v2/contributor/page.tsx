...
const ContributorPage = () => {
    ...
    const chartData = useMemo(() => {
        ...
        const maxVal = Math.max(...performanceRes.data.five_top_elements.map((e: any) => e.count), 5);
        return performanceRes.data.five_top_elements.map((e: any) => ({
            name: e.element_name,
            value: e.count,
            max: maxVal,
        }));
        ...
        <DashboardLayout>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Berikut adalah ringkasan data yang telah anda kontribusikan.</p>
                </div>
            </div>
