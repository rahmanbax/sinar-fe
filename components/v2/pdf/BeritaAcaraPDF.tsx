...
// Register fonts if necessary, but Helvetica is built-in
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.titleContainer}>
                    ...
                    <Text style={styles.title}>NOMOR: {nomorBeritaAcara?.toUpperCase() || '.......................'}</Text>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.listItem}>
                        ...
                        <Text style={styles.listItemContent}>
                            Acara secara resmi dibuka oleh {namaPembukaAcara || '.......................'} selaku {jabatanPembukaAcara || '.......................'}, Badan Informasi Geospasial (BIG). Acara dihadiri oleh perwakilan dari Badan Informasi Geospasial{instansiTerlibat ? ' dan ' + instansiTerlibat : ''}.
                        </Text>
                    </View>
