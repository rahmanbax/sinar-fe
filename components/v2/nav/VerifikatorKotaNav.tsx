...
interface VerifikatorKotaNavProps {
    isOpen?: boolean;
    onClose?: () => void;
}

const VerifikatorKotaNav = ({ isOpen = false, onClose }: VerifikatorKotaNavProps) => {
...
export default VerifikatorKotaNav;